-- Deploy hashids-plgpsql:create.function.hashids.setup_alphabet to pg
-- requires: create.function.hashids.distinct_alphabet
-- requires: create.function.hashids.clean_seps_from_alphabet
-- requires: create.function.hashids.clean_alphabet_from_seps
